...
from .parse import DeepSeekV32Parser, GeneralParser, HarmonyParser, ThinkingParser
...
def preprocess_conversations(
    ...
    **kwargs,
    ...
    elif chat_template.parser_type == "deepseek-v32":
        parser = DeepSeekV32Parser(tokenizer, chat_template)
    else:
